...
namespace UniversityManagementSystem.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,TeacherName,Address,Email,ContactNo,DesignationId,DepartmentId")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,TeacherName,Address,Email,ContactNo,DesignationId,DepartmentId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
